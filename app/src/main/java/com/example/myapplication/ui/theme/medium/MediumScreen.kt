...
fun MediumScreen(
    ...
    Column(
        ...
        val colors = mediumGenerateColorGrid(
            coordinates = coordinates, foodCoordinates = snakeViewModel.foodCoordinates,
...
fun mediumGenerateColorGrid(
    coordinates: List<Pair<Int, Int>>, foodCoordinates: Pair<Int, Int>,
    giantFoodCoordinates: Pair<Int, Int>?
): List<Color> {
